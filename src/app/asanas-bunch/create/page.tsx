...
const CreateAsanasBunchPage: React.FC = () => {
  ...
  const {createAsanasBunch} = useAsanaBunch()
  const {updateAsanasBunches} = useAsanasBunches()
  ...
  const onSave = useCallback(async () => {
    const {id} = (await createAsanasBunch({title, asanas: asanasBunch})) ?? {}
  ...
  }, [asanasBunch, createAsanasBunch, router, title, updateAsanasBunches])
